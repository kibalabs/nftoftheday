...
from notd.api.endpoints_v1 import UpdateTotalActivityForAllCollectionsResponse
...
def create_api(notdManager: NotdManager, responseBuilder: ResponseBuilder) -> APIRouter:
    ...
    @router.post('/collections/update-total-activity-deferred', response_model=UpdateTotalActivityForAllCollectionsResponse)
    async def update_total_activity_for_all_collections():
        await notdManager.update_total_activity_for_all_collections()
        return UpdateTotalActivityForAllCollectionsResponse()
