...
class ListUserBlueChipCollectionsTokensRequest(BaseModel):
    pass

class ListUserBlueChipCollectionsTokensResponse(BaseModel):
    collectionTokens: List[ApiCollectionToken]
