...
class NotdManager:
    ...
    async def update_attributes_for_all_tokens_deferred(self) -> None:
        await self.tokenManager.update_attributes_for_all_tokens_deferred()
    ...
    async def update_attribute_for_all_tokens(self) -> None:
        await self.tokenManager.update_attribute_for_all_tokens()
    ...
    def _uniqueness_tuple_from_token_transfer(tokenTransfer: TokenTransfer) -> Tuple[str, str, str, str, str, int, int, str, bool, bool, bool, bool, bool, str]:
        return (tokenTransfer.transactionHash, tokenTransfer.registryAddress, tokenTransfer.tokenId, tokenTransfer.fromAddress, tokenTransfer.toAddress, tokenTransfer.blockNumber, tokenTransfer.amount, tokenTransfer.tokenType, tokenTransfer.isMultiAddress, tokenTransfer.isInterstitial, tokenTransfer.isBatch, tokenTransfer.isSwap, tokenTransfer.isOutbound, tokenTransfer.contractAddress)
