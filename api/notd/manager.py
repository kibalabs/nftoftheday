...
class NotdManager:
    ...
    def _uniqueness_tuple_from_token_transfer(tokenTransfer: TokenTransfer) -> Tuple[str, str, str, str, str, int, int, int, str, bool, bool, bool, bool, bool, str]:
        return (tokenTransfer.transactionHash, tokenTransfer.registryAddress, tokenTransfer.tokenId, tokenTransfer.fromAddress, tokenTransfer.toAddress, tokenTransfer.blockNumber, tokenTransfer.value, tokenTransfer.amount, tokenTransfer.tokenType, tokenTransfer.isMultiAddress, tokenTransfer.isInterstitial, tokenTransfer.isBatch, tokenTransfer.isSwap, tokenTransfer.isOutbound, tokenTransfer.contractAddress)
