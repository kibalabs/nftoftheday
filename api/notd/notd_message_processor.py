...
class NotdMessageProcessor(MessageProcessor):
    ...
    async def process_message(self, message: Message) -> None:
        ...
        if message.command == RefreshGalleryBadgeHoldersForCollectionMessageContent.get_command():
            ...
            return
        if message.command == RefreshTokenStakingsForStakingAddressMessageContent.get_command():
            refreshTokenStakingsForStakingAddressMessageContent = RefreshTokenStakingsForStakingAddressMessageContent.parse_obj(message.content)
            await self.notdManager.refresh_token_stakings_for_staking_address(stakingAddress=refreshTokenStakingsForStakingAddressMessageContent.stakingAddress)
            return
