...
class NotdMessageProcessor(MessageProcessor):
    ...
    async def process_message(self, message: SqsMessage) -> None:
        if message.command == ProcessBlocksMessageContent._COMMAND:   # pylint: disable=W0212
            ...
            return
        if message.command == ProcessBlockRangeMessageContent._COMMAND: # pylint: disable=W0212
            ...
            return
        if message.command == ReceiveNewBlocksMessageContent._COMMAND: # pylint: disable=W0212
