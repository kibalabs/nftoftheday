...
export const CollectionPage = (): React.ReactElement => {
  ...
  const tokenTransfer = new TokenTransfer(86323519, '0x4de7e4cbaac06e3a4fa55b8af17bf72d23f90d9d6ccace517928bd3dbb8fbf2b', '0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7', '0xEC1B09e43100957D7623661F43364e65175eeC08', '0xEC1B09e43100957D7623661F43364e65175eeC08', '0', 6, 8999999, 98, 98889, 89889, '0x923dec2cb340dbd22a861070bb321752abec2416f24135bf473ce66fcb9479d4', new Date());
              ...
              <Stack direction={Direction.Vertical} isFullWidth={true} childAlignment={Alignment.Start} shouldAddGutters={true} paddingVertical={PaddingSize.Wide2}>
                ...
                <Stack direction={Direction.Horizontal}contentAlignment={Alignment.Center} childAlignment={Alignment.Center} shouldAddGutters={true} defaultGutter={PaddingSize.Wide}>
                  {COLLECTION_TOKENS.map((collectionToken: CollectionToken, index: number) : React.ReactElement => (
                    <TokenCard
                      key={index} collectionToken={collectionToken}
                      subtitle={`Sold at ${dateToString(tokenTransfer.blockDate, 'HH:mm')} for Ξ${tokenTransfer.value / 1000000000000000000.0}`}
                    />
                  ))}
                </Stack>
