...
GRANT USAGE ON SCHEMA public TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_token_transfers TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_transfers_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_token_metadatas TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_metadatas_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_collections TO obafemi;
GRANT ALL ON SEQUENCE tbl_collections_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_blocks TO obafemi;
GRANT ALL ON SEQUENCE tbl_blocks_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_token_ownerships TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_ownerships_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_token_multi_ownerships TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_multi_ownerships_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_collection_hourly_activities TO obafemi;
GRANT ALL ON SEQUENCE tbl_collection_hourly_activities_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_collection_total_activities TO obafemi;
GRANT ALL ON SEQUENCE tbl_collection_total_activities_id_seq TO obafemi;
GRANT INSERT, SELECT ON tbl_user_interactions TO obafemi;
GRANT ALL ON SEQUENCE tbl_user_interactions_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_latest_updates TO obafemi;
GRANT ALL ON SEQUENCE tbl_latest_updates_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_latest_token_listings TO obafemi;
GRANT ALL ON SEQUENCE tbl_latest_token_listings_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_token_attributes TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_attributes_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_token_customizations TO obafemi;
GRANT ALL ON SEQUENCE tbl_token_customizations_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_locks TO obafemi;
GRANT ALL ON SEQUENCE tbl_locks_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_twitter_profiles TO obafemi;
GRANT ALL ON SEQUENCE tbl_twitter_profiles_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_user_profiles TO obafemi;
GRANT ALL ON SEQUENCE tbl_user_profiles_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_gallery_customers TO obafemi;
GRANT ALL ON SEQUENCE tbl_gallery_customers_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_account_gms TO obafemi;
GRANT ALL ON SEQUENCE tbl_account_gms_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE ON tbl_account_collection_gms TO obafemi;
GRANT ALL ON SEQUENCE tbl_account_collection_gms_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_collection_overlaps TO obafemi;
GRANT ALL ON SEQUENCE tbl_collection_overlaps_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_gallery_badge_holders TO obafemi;
GRANT ALL ON SEQUENCE tbl_gallery_badge_holders_id_seq TO obafemi;
GRANT INSERT, SELECT, UPDATE, DELETE ON tbl_gallery_badge_assignments TO obafemi;
GRANT ALL ON SEQUENCE tbl_gallery_badge_assignments_id_seq TO obafemi;
...
ALTER MATERIALIZED VIEW mvw_user_registry_first_ownerships OWNER TO obafemi;
ALTER MATERIALIZED VIEW mvw_user_registry_ordered_ownerships OWNER TO obafemi;
